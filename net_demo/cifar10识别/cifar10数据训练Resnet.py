...
class ResNet18(Model):
    ...
    def __init__(self, block_list, initial_filters=64):  # block_list表示每个block有几个卷积层
        ...
        self.f1 = layers.Dense(10, activation='softmax', kernel_regularizer=regularizers.l2())
    def call(self, inputs):
        x = self.c1(inputs)
        x = self.b1(x)
        x = self.a1(x)
...
history = model.fit(x_train, y_train, batch_size=128, epochs=1, validation_data=(x_test, y_test), validation_freq=1,
